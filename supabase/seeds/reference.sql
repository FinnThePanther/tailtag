...
INSERT INTO daily_tasks (id, name, description, kind, requirement, metadata, is_active, rule_id, convention_id) VALUES
  ...
  ('86765af1-77e8-4ca0-a3dc-51531dc9c6c2', 'Catch 10 suiters',              'Go on a catching spree by snagging ten suiters today.',     'catch',       10, '{"metric":"total","eventType":"catch_performed"}',                                                                     true,  null, null),
  ...
  ('8b5f9a7a-8d7d-4e89-9a92-4fd4b45b8b71', 'Same Studio',                  'Catch a suit from a maker that also made one of yours.',     'catch',       1,  '{"metric":"total","eventType":"catch_performed","filters":[{"path":"payload.catcher_id","equalsUserId":true},{"path":"payload.has_catcher_owned_maker_match","equals":true}]}', true, null, null),
  ('3327bbbe-2c41-421d-ad0b-ed1c3fb22d60', 'Studio Sampler',               'Catch suits from two different makers today.',               'catch',       2,  '{"metric":"unique","uniqueBy":"payload.normalized_maker_names","eventType":"catch_performed","filters":[{"path":"payload.catcher_id","equalsUserId":true},{"path":"payload.has_maker","equals":true}]}', true, null, null),
  ('ee1c9130-0db4-48cf-bbb6-64f965a563c7', 'Fresh Workshop',               'Catch a maker you have not caught earlier at this convention.', 'catch',    1,  '{"metric":"total","eventType":"catch_performed","filters":[{"path":"payload.catcher_id","equalsUserId":true},{"path":"payload.is_new_maker_for_catcher_at_convention","equals":true}]}', true, null, null)
ON CONFLICT (id) DO NOTHING;
