...
INSERT INTO daily_tasks (id, name, description, kind, requirement, metadata, is_active, rule_id, convention_id) VALUES
  ...
  ('86765af1-77e8-4ca0-a3dc-51531dc9c6c2', 'Catch 10 suiters today',        'Go on a catching spree by snagging ten suiters today.',     'catch',       10, '{"metric":"total","eventType":"catch_performed","rotation":{"eligible":false,"slot":"catch","difficulty":"hard","family":"catch_volume"},"leveling":{"xp":75}}', true,  null, null),
  ...
  ('c5914eb9-dbd2-41b0-8176-b98199e1eccf', 'Refresh the leaderboard twice', 'Check back in on the leaderboard a second time.',           'leaderboard', 2,  '{"metric":"total","eventType":"leaderboard_refreshed","rotation":{"eligible":false,"slot":"leaderboard","difficulty":"medium","family":"leaderboard_check"},"leveling":{"xp":25}}', true,  null, null),
  ('395a6cc9-57fd-4b8a-8293-12a02118516e', 'Share a catch',                 'Show off your haul by sharing one of your catches.',         'share',       1,  '{"metric":"total","filters":[{"path":"payload.context","equals":"catch_screen"}],"eventType":"catch_shared","rotation":{"eligible":false,"slot":"social","difficulty":"medium","family":"share_catch"},"leveling":{"xp":50}}', false, null, null),
  ('cb5b3440-baba-49ab-8ece-d210b71208b2', 'Share two catches',             'Double up and share two catches today.',                     'share',       2,  '{"metric":"total","filters":[{"path":"payload.context","equals":"catch_screen"}],"eventType":"catch_shared","rotation":{"eligible":false,"slot":"social","difficulty":"hard","family":"share_catch"},"leveling":{"xp":75}}', false, null, null),
