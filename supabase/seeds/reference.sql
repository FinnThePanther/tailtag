...
INSERT INTO allowed_event_types (event_type, description, is_active) VALUES
  ...
  ('convention_detail_viewed',   'Convention detail view event for daily task tracking',    true),
  ('convention_joined',          'User joined a convention',                                true),
  ('convention_left',            'User left a convention',                                  true),
  ('convention_roster_viewed',   'Convention roster view event for daily task tracking',    true),
...
INSERT INTO achievement_rules (rule_id, kind, slug, name, description, is_active, version, rule, metadata) VALUES
  ...
  ('f1a7b000-0000-4000-8000-000000000001', 'permanent', 'first_fan',          'First Fan',               'One of your suits has been caught by 2 unique people',                              true, 1, '{}', '{}'),
  ...
  ('f1a7b000-0000-4000-8000-000000000006', 'permanent', 'early_bird',         'Early Bird',              'Make a catch from 5:00-9:59 AM local convention time',                              true, 1, '{}', '{}'),
...
INSERT INTO achievements (id, key, name, description, category, recipient_role, trigger_event, is_active, rule_id, reset_mode, reset_timezone, reset_grace_minutes, convention_id) VALUES
  ...
  ('75d3ec8d-2e0d-46a8-b1cf-9e84477f4291', 'EARLY_BIRD',              'Early Bird',              'Make a catch from 5:00-9:59 AM local convention time.',                      'dedication',  'catcher',        'catch_performed',   true, 'f1a7b000-0000-4000-8000-000000000006', 'none', 'UTC', 0, null),
  ...
  ('f03f504c-af2d-4ee0-a7e9-2bccbf8f5e89', 'FIRST_FAN',               'First Fan',               'One of your suits has been caught by 2 unique people.',                      'fursuiter',   'fursuit_owner',  'catch_performed',   true, 'f1a7b000-0000-4000-8000-000000000001', 'none', 'UTC', 0, null),
...
-- -----------------------------------------------------------------------------
-- 6. Daily Tasks (21 rows) — 2 inactive share tasks, 19 active
-- -----------------------------------------------------------------------------
INSERT INTO daily_tasks (id, name, description, kind, requirement, metadata, is_active, rule_id, convention_id) VALUES
  ('e9c1d39b-1cf4-4a93-80f5-d428dd286560', 'Open the leaderboard',          'See who is leading the pack right now.',                   'leaderboard', 1,  '{"metric":"total","eventType":"leaderboard_refreshed","rotation":{"eligible":true,"slot":"leaderboard","difficulty":"easy","family":"leaderboard_check"},"leveling":{"xp":25}}', true,  null, null),
  ('918258d9-651d-4e24-9c61-b4703ce4852e', 'Catch 1 suiter today',          'Kick off the day by catching any suiter.',                 'catch',       1,  '{"metric":"total","eventType":"catch_performed","rotation":{"eligible":true,"slot":"catch","difficulty":"easy","family":"catch_volume"},"leveling":{"xp":25}}', true,  null, null),
  ('a0aa9a53-0a7b-4bf7-a7a3-e6f2a84feac2', 'Catch 2 suiters today',         'Build momentum by catching two suiters.',                  'catch',       2,  '{"metric":"total","eventType":"catch_performed","rotation":{"eligible":true,"slot":"catch","difficulty":"easy","family":"catch_volume"},"leveling":{"xp":35}}', true,  null, null),
  ('26139b89-a341-454a-bba8-3ff38c2f51ac', 'Catch 3 suiters today',         'Keep the momentum going with three total catches.',         'catch',       3,  '{"metric":"total","eventType":"catch_performed","rotation":{"eligible":true,"slot":"catch","difficulty":"medium","family":"catch_volume"},"leveling":{"xp":50}}', true,  null, null),
  ('df526046-9edc-4fff-8b35-efa3a8658b9d', 'Catch 4 suiters today',         'Keep the con floor energy going with four catches.',        'catch',       4,  '{"metric":"total","eventType":"catch_performed","rotation":{"eligible":true,"slot":"catch","difficulty":"medium","family":"catch_volume"},"leveling":{"xp":60}}', true,  null, null),
  ('86765af1-77e8-4ca0-a3dc-51531dc9c6c2', 'Catch 10 suiters today',        'Go on a catching spree by snagging ten suiters today.',     'catch',       10, '{"metric":"total","eventType":"catch_performed","rotation":{"eligible":false,"slot":"catch","difficulty":"hard","family":"catch_volume"},"leveling":{"xp":75},"defaultRotationEligible":false}', true,  null, null),
  ('416199d2-3cec-45c6-a52c-0699a1688e81', 'Catch 2 unique suiters',        'Catch two different suiters today.',                       'catch',       2,  '{"metric":"unique","uniqueBy":"payload.fursuit_id","eventType":"catch_performed","rotation":{"eligible":true,"slot":"catch","difficulty":"easy","family":"catch_unique"},"leveling":{"xp":35}}', true,  null, null),
  ('0eee75c3-275c-406c-9e00-763c0dff9443', 'Catch 3 unique suiters',        'Catch three different suiters today.',                     'catch',       3,  '{"metric":"unique","uniqueBy":"payload.fursuit_id","eventType":"catch_performed","rotation":{"eligible":true,"slot":"catch","difficulty":"medium","family":"catch_unique"},"leveling":{"xp":50}}', true,  null, null),
  ('85a59e7b-6906-4b84-a133-95a25a1f2937', 'Catch 5 unique suiters',        'Track down five different suiters in a single day.',         'catch',       5,  '{"metric":"unique","uniqueBy":"payload.fursuit_id","eventType":"catch_performed","rotation":{"eligible":true,"slot":"catch","difficulty":"hard","family":"catch_unique"},"leveling":{"xp":75}}', true,  null, null),
  ('c5914eb9-dbd2-41b0-8176-b98199e1eccf', 'Refresh the leaderboard twice', 'Check back in on the leaderboard a second time.',           'leaderboard', 2,  '{"metric":"total","eventType":"leaderboard_refreshed","rotation":{"eligible":false,"slot":"leaderboard","difficulty":"medium","family":"leaderboard_check"},"leveling":{"xp":25},"defaultRotationEligible":false}', true,  null, null),
  ('8a1d69ee-2d01-4c7f-8c46-b1641e304eb8', 'Check your convention roster',  'Open the fursuit roster for your convention.',              'view_bio',    1,  '{"metric":"total","eventType":"convention_roster_viewed","rotation":{"eligible":true,"slot":"explore","difficulty":"easy","family":"roster_view"},"leveling":{"xp":25}}', true, null, null),
  ('13208a7a-f005-4640-bf91-475ad241db63', 'Open convention details',       'Check the current details for your convention.',             'view_bio',    1,  '{"metric":"total","eventType":"convention_detail_viewed","rotation":{"eligible":false,"slot":"explore","difficulty":"easy","family":"convention_view"},"leveling":{"xp":25}}', false, null, null),
  ('395a6cc9-57fd-4b8a-8293-12a02118516e', 'Share a catch',                 'Show off your haul by sharing one of your catches.',         'share',       1,  '{"metric":"total","filters":[{"path":"payload.context","equals":"catch_screen"}],"eventType":"catch_shared","rotation":{"eligible":false,"slot":"social","difficulty":"medium","family":"share_catch"},"leveling":{"xp":50},"defaultRotationEligible":false}', false, null, null),
  ('cb5b3440-baba-49ab-8ece-d210b71208b2', 'Share two catches',             'Double up and share two catches today.',                     'share',       2,  '{"metric":"total","filters":[{"path":"payload.context","equals":"catch_screen"}],"eventType":"catch_shared","rotation":{"eligible":false,"slot":"social","difficulty":"hard","family":"share_catch"},"leveling":{"xp":75},"defaultRotationEligible":false}', false, null, null),
  ('190aa081-2120-4a89-8b5a-0ee0cb576ce2', 'View 1 suiter bio',             'Open any suiter bio to learn more about them.',              'view_bio',    1,  '{"metric":"total","filters":[{"path":"payload.owner_id","notEqualsUserId":true}],"eventType":"fursuit_bio_viewed","rotation":{"eligible":true,"slot":"explore","difficulty":"easy","family":"bio_views"},"leveling":{"xp":35}}', true,  null, null),
  ('04cebb38-d2d1-49e7-a1c9-3caefb454ce7', 'View 2 suiter bios',            'Open two suiter bios and learn who is around.',              'view_bio',    2,  '{"metric":"unique","filters":[{"path":"payload.owner_id","notEqualsUserId":true}],"uniqueBy":"payload.fursuit_id","eventType":"fursuit_bio_viewed","rotation":{"eligible":true,"slot":"explore","difficulty":"easy","family":"bio_views"},"leveling":{"xp":45}}', true, null, null),
  ('61334de8-f453-488f-9a8f-35ded68483e3', 'View 3 suiter bios',            'Check out bios for three different suiters.',                'view_bio',    3,  '{"metric":"unique","filters":[{"path":"payload.owner_id","notEqualsUserId":true}],"uniqueBy":"payload.fursuit_id","eventType":"fursuit_bio_viewed","rotation":{"eligible":true,"slot":"explore","difficulty":"medium","family":"bio_views"},"leveling":{"xp":60}}', true, null, null),
  ('c65a5c84-89a9-486b-b702-d5f3c2e41a1a', 'View 5 suiter bios',            'Browse five different suiter bios in one day.',              'view_bio',    5,  '{"metric":"unique","filters":[{"path":"payload.owner_id","notEqualsUserId":true}],"uniqueBy":"payload.fursuit_id","eventType":"fursuit_bio_viewed","rotation":{"eligible":true,"slot":"explore","difficulty":"hard","family":"bio_views"},"leveling":{"xp":80}}', true, null, null),
  ('8b5f9a7a-8d7d-4e89-9a92-4fd4b45b8b71', 'Same Studio',                  'Catch a suit from a maker that also made one of yours.',     'catch',       1,  '{"metric":"total","eventType":"catch_performed","filters":[{"path":"payload.catcher_id","equalsUserId":true},{"path":"payload.has_catcher_owned_maker_match","equals":true}],"rotation":{"eligible":false,"slot":"special","difficulty":"special","family":"maker_metadata"},"leveling":{"xp":100},"defaultRotationEligible":false,"rotationPool":"special"}', true, null, null),
  ('3327bbbe-2c41-421d-ad0b-ed1c3fb22d60', 'Studio Sampler',               'Catch suits from two different makers today.',               'catch',       2,  '{"metric":"unique","uniqueBy":"payload.normalized_maker_names","eventType":"catch_performed","filters":[{"path":"payload.catcher_id","equalsUserId":true},{"path":"payload.has_maker","equals":true}],"rotation":{"eligible":false,"slot":"special","difficulty":"special","family":"maker_metadata"},"leveling":{"xp":100},"defaultRotationEligible":false,"rotationPool":"special"}', true, null, null),
  ('ee1c9130-0db4-48cf-bbb6-64f965a563c7', 'Fresh Workshop',               'Catch a maker you have not caught earlier at this convention.', 'catch',    1,  '{"metric":"total","eventType":"catch_performed","filters":[{"path":"payload.catcher_id","equalsUserId":true},{"path":"payload.is_new_maker_for_catcher_at_convention","equals":true}],"rotation":{"eligible":false,"slot":"special","difficulty":"special","family":"maker_metadata"},"leveling":{"xp":100},"defaultRotationEligible":false,"rotationPool":"special"}', true, null, null)
ON CONFLICT (id) DO NOTHING;
