...
INSERT INTO daily_tasks (id, name, description, kind, requirement, metadata, is_active, rule_id, convention_id) VALUES
  ...
  ('13208a7a-f005-4640-bf91-475ad241db63', 'Open convention details',       'Check the current details for your convention.',             'view_bio',    1,  '{"metric":"total","eventType":"convention_detail_viewed","rotation":{"eligible":true,"slot":"explore","difficulty":"easy","family":"convention_view"},"leveling":{"xp":25}}', true, null, null),
