...
CREATE OR REPLACE FUNCTION public.update_fursuit_profile(
  ...
  p_color_details text DEFAULT '__tailtag_preserve_color_details__'
)
RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
...
DECLARE
  ...
  v_preserve_color_details boolean := p_color_details IS NOT DISTINCT FROM '__tailtag_preserve_color_details__';
