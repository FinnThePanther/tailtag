-- Reconcile staging/dev drift for catch reward pipeline after divergent migration IDs.
-- This migration is intentionally idempotent and safe to run in both environments.
