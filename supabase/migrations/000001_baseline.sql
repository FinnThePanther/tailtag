...
CREATE POLICY "Public read fursuit avatars" ON "storage"."objects" FOR SELECT USING (("bucket_id" = 'fursuit-avatars'::"text"));



CREATE POLICY "User avatar delete" ON "storage"."objects" FOR DELETE TO "authenticated" USING ((("bucket_id" = 'avatars'::"text") AND (("auth"."uid"())::"text" = "split_part"("name", '/'::"text", 1))));



CREATE POLICY "User avatar update" ON "storage"."objects" FOR UPDATE TO "authenticated" USING ((("bucket_id" = 'avatars'::"text") AND (("auth"."uid"())::"text" = "split_part"("name", '/'::"text", 1)))) WITH CHECK ((("bucket_id" = 'avatars'::"text") AND (("auth"."uid"())::"text" = "split_part"("name", '/'::"text", 1))));



CREATE POLICY "User avatar upload" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK ((("bucket_id" = 'avatars'::"text") AND (("auth"."uid"())::"text" = "split_part"("name", '/'::"text", 1))));



CREATE POLICY "Users delete fursuit avatars" ON "storage"."objects" FOR DELETE TO "authenticated" USING ((("bucket_id" = 'fursuit-avatars'::"text") AND ("split_part"("name", '/'::"text", 1) = ("auth"."uid"())::"text")));



CREATE POLICY "Users update fursuit avatars" ON "storage"."objects" FOR UPDATE TO "authenticated" USING ((("bucket_id" = 'fursuit-avatars'::"text") AND ("split_part"("name", '/'::"text", 1) = ("auth"."uid"())::"text"))) WITH CHECK ((("bucket_id" = 'fursuit-avatars'::"text") AND ("split_part"("name", '/'::"text", 1) = ("auth"."uid"())::"text")));



CREATE POLICY "Users upload fursuit avatars" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK ((("bucket_id" = 'fursuit-avatars'::"text") AND ("split_part"("name", '/'::"text", 1) = ("auth"."uid"())::"text")));
