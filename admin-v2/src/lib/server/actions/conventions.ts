...
import { assertNotCheckedInConventionAchievement } from '$lib/server/achievement-identity';
...
export async function generateConventionGameplayPackAction(cookies: Cookies, conventionId: string) {
  const { profile } = await assertAdminAction(cookies, [...CONTENT_ROLES]);
  const supabase = createServiceRoleClient();
...
export async function runConventionReadinessCheckAction(cookies: Cookies, conventionId: string) {
  const { profile } = await assertAdminAction(cookies, [...CONFIG_ROLES]);
  const supabase = createServiceRoleClient();
...
export async function startConventionAction(cookies: Cookies, conventionId: string) {
  const { profile } = await assertAdminAction(cookies, [...CONFIG_ROLES]);
  const supabase = createServiceRoleClient();
...
export async function rotateConventionDailiesAction(cookies: Cookies, conventionId: string) {
  const { profile } = await assertAdminAction(cookies, [...CONTENT_ROLES]);
...
export async function closeConventionAction(cookies: Cookies, conventionId: string) {
  const { profile } = await assertAdminAction(cookies, [...CONFIG_ROLES]);
...
export async function retryConventionCloseoutAction(cookies: Cookies, conventionId: string) {
  const { profile } = await assertAdminAction(cookies, [...CONFIG_ROLES]);
...
export async function regenerateConventionRecapsAction(cookies: Cookies, conventionId: string) {
  const { profile } = await assertAdminAction(cookies, [...CONFIG_ROLES]);
...
export async function deleteArchivedConventionInDevAction(cookies: Cookies, conventionId: string) {
  const { profile } = await assertAdminAction(cookies, [...CONFIG_ROLES]);
...
export async function updateConventionConfigAction(
  cookies: Cookies,
  input: {
    conventionId: string;
...
export async function updateConventionGeofenceAction(
  cookies: Cookies,
  input: {
    conventionId: string;
...
export async function createConventionTaskAction(
  cookies: Cookies,
  input: {
    conventionId: string;
    name: string;
...
export async function toggleConventionTaskAction(
  cookies: Cookies,
  input: {
    taskId: string;
    isActive: boolean;
...
export async function updateConventionTaskAction(
  cookies: Cookies,
  input: {
    taskId: string;
    conventionId: string;
...
export async function deleteConventionTaskAction(
  cookies: Cookies,
  input: { taskId: string; conventionId: string },
) {
  const { profile } = await assertAdminAction(cookies, [...CONTENT_ROLES]);
  const supabase = createServiceRoleClient();
...
export async function createConventionAchievementAction(
  cookies: Cookies,
  input: {
    conventionId: string;
    key: string;
...
export async function toggleConventionAchievementAction(
  cookies: Cookies,
  input: {
...
export async function updateConventionAchievementAction(
  cookies: Cookies,
  input: {
    achievementId: string;
    conventionId: string;
...
export async function deleteConventionAchievementAction(
  cookies: Cookies,
  input: {
    achievementId: string;
    conventionId: string;
