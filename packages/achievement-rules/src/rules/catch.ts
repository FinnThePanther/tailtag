  ...
  },
  {
    ...
    evaluate(context) {
      ...
      return context.stats.totalCatches >= 10
        ? awardSingle(
            context,
            ACHIEVEMENT_RULE_IDS.GETTING_THE_HANG_OF_IT,
  ...
  },
  {
    ...
    evaluate(context) {
      ...
      return context.stats.totalCatches >= 25
        ? awardSingle(
            context,
            ACHIEVEMENT_RULE_IDS.SUPER_CATCHER,
            'SUPER_CATCHER',
            context.catcherId,
            {
              total_catches: context.stats.totalCatches,
  ...
  },
  {
    ...
    evaluate(context) {
      ...
      return context.stats.totalFursuitCatches === 1
        ? awardSingle(
            context,
            ACHIEVEMENT_RULE_IDS.DEBUT_PERFORMANCE,
            'DEBUT_PERFORMANCE',
            context.fursuitOwnerId,
            {
  ...
  },
  {
    ...
    evaluate(context) {
      ...
      return context.timing.isConventionDayOne
        ? awardSingle(
            context,
            ACHIEVEMENT_RULE_IDS.DAY_ONE_DEVOTEE,
            'DAY_ONE_DEVOTEE',
            context.catcherId,
          )
        : [];
  ...
  },
  {
    ...
    evaluate(context) {
      ...
      return context.stats.distinctSpeciesCaught >= 5
        ? awardSingle(
            context,
            ACHIEVEMENT_RULE_IDS.SUIT_SAMPLER,
            'SUIT_SAMPLER',
            context.catcherId,
            {
  ...
  },
  {
    ...
    evaluate(context) {
      ...
      return context.flags.hybridFursuit
        ? awardSingle(
            context,
            ACHIEVEMENT_RULE_IDS.MIX_AND_MATCH,
            'MIX_AND_MATCH',
            context.catcherId,
          )
        : [];
  ...
  },
  {
    ...
    evaluate(context) {
      ...
      return context.flags.hybridFursuit
        ? awardSingle(
            context,
            ACHIEVEMENT_RULE_IDS.HYBRID_VIBES,
            'HYBRID_VIBES',
            context.fursuitOwnerId,
            {
              owner_id: context.fursuitOwnerId,
  ...
  },
  {
    ...
    evaluate(context) {
      ...
      return context.flags.doubleCatchWithinMinute
        ? awardSingle(
            context,
            ACHIEVEMENT_RULE_IDS.DOUBLE_TROUBLE,
            'DOUBLE_TROUBLE',
            context.catcherId,
          )
        : [];
  ...
  },
  {
    ...
    evaluate(context) {
      ...
      return context.stats.catchesAtConvention >= 25
        ? awardSingle(
            context,
            ACHIEVEMENT_RULE_IDS.FAN_FAVORITE,
            'FAN_FAVORITE',
            context.fursuitOwnerId,
            {
              owner_id: context.fursuitOwnerId,
  ...
  },
  {
    ...
    evaluate(context) {
      ...
      return context.timing.isConventionDayOne
        ? awardSingle(
            context,
            ACHIEVEMENT_RULE_IDS.OPENING_NUMBER,
            'OPENING_NUMBER',
            context.fursuitOwnerId,
            {
              owner_id: context.fursuitOwnerId,
  ...
  },
  {
    ...
    evaluate(context) {
      ...
      return context.stats.distinctLocalDaysForFursuitAtConvention >= 2
        ? awardSingle(
            context,
            ACHIEVEMENT_RULE_IDS.WEEKEND_WARRIOR,
            'WEEKEND_WARRIOR',
            context.fursuitOwnerId,
            {
              owner_id: context.fursuitOwnerId,
  ...
  },
  {
    ...
    evaluate(context) {
      ...
      return context.stats.distinctConventionsForFursuit >= 2
        ? awardSingle(
            context,
            ACHIEVEMENT_RULE_IDS.ROAD_TRIP,
            'ROAD_TRIP',
            context.fursuitOwnerId,
            {
              owner_id: context.fursuitOwnerId,
  ...
  },
  {
    ...
    evaluate(context) {
      ...
      return context.stats.distinctSpeciesCaught >= 10
        ? awardSingle(
            context,
            ACHIEVEMENT_RULE_IDS.SPECIES_SAFARI,
            'SPECIES_SAFARI',
            context.catcherId,
            {
  ...
  },
  {
    ...
    evaluate(context) {
      ...
      return context.stats.catchesByCatcherToday >= 5
        ? awardSingle(
            context,
            ACHIEVEMENT_RULE_IDS.SOCIAL_BUTTERFLY,
            'SOCIAL_BUTTERFLY',
            context.catcherId,
            {
