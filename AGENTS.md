...
TailTag is past beta and V1 has been released. Current work should target V1+ product quality, not throwaway prototype or pre-release behavior. Default design and implementation decisions should optimize for a live, production app with real users:

- Prefer complete, user-facing flows over temporary MVP shortcuts.
- Keep UX polished, clear, and resilient for real production users.
...
- Favor maintainable feature foundations that can evolve through V1+ without immediate rewrites.
